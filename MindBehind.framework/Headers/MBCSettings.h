...
#import "MBCAuthenticationDelegate.h"
 ...
 */
extern NSString *const MBCMenuItemCamera;
 ...
 *
 *  @param integrationId A valid integration id retrieved from the MindBehind web portal.
 *  @param authCode A valid auth code generated from the MindBehind API.
 */
 ...
 *
 *  @discussion App id can be retrieved from the MindBehind web portal
 *
 ...
 *
 *  @discussion integration id can be retrieved from the MindBehind web portal
 *
 *  This value may only be set once, and must be set at init time.
 */
 ...
 *
 *  @discussion Auth code can be retrieved from the MindBehind API
 *
 *  This value may only be set once, and must be set at init time.
 */
...
/**
 *  @abstract The MindBehind region for this account.
 *
 ...
 *
 *  @discussion Valid values are MBCMenuItemCamera, MBCMenuItemGallery, MBCMenuItemDocument and MBCMenuItemLocation
 *
 ...
 *
 *  @discussion When set to YES, MindBehind will swizzle the following methods of your UIApplicationDelegate in order to automatically handle push notification receiving and registering, as well as user notification handling.
 *
 ...
 *
 *  If set to NO, MindBehind will not perform swizzling. It is up to the app to handle MindBehind push notifications by doing the following:
 *
 *  1. When a new push token is received in -application:didRegisterForRemoteNotificationsWithDeviceToken:, you must call MindBehind +setPushToken.
 *  2. In your -application:didReceiveRemoteNotification: or -application:didReceiveRemoteNotification:fetchCompletionHandler: callback, you must call MindBehind +handlePushNotification: with the passed userInfo dictionary.
 *  3. In your -application:handleActionWithIdentifier:forRemoteNotification:withResponseInfo:completionHandler: callback, you must call MindBehind +handleUserNotificationActionWithIdentifier:withResponseInfo:completionHandler: with the correct parameters.
 *
 ...
 *
 *  @discussion For more information, see the +userNotificationCenterDelegate method of the MindBehind class.
 *
 *  If set to NO, the application must forward calls from its own UNUserNotificationCenterDelegate to MindBehind to ensure proper handling of notifications on iOS 10.
 *
 *  The default value is YES.
 *
 *  @see MindBehind
 ...
 *
 *  If set to NO, the application must make sure to register the MindBehind user notification category settings. For more information, see the +userNotificationCategories method of the MindBehind class.
 *
 *  The default value is YES.
 *
 *  @see MindBehind
 ...
 *  This value may only be set once, and must be set at init time.
 *
 *  @see MBCAuthenticationDelegate
 */
@property(nullable) id<MBCAuthenticationDelegate> authenticationDelegate;
