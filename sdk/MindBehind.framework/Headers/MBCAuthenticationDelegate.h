...
typedef void (^MBCAuthenticationCompletionBlock)(NSString *jwt);
 ...
 */
@protocol MBCAuthenticationDelegate <NSObject>
 ...
 */
- (void)onInvalidToken:(NSError *) error handler:(MBCAuthenticationCompletionBlock)completionHandler;
